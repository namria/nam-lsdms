...
Public Class MainForm
    Dim ConnString As String = "Data Source=" & GetSetting("servers", "DatabaseServer", "name") & ";Initial Catalog={0};Persist Security Info=True;User ID=prs92;Password=prs92"
...
Abort:
    ...
    Private Function IsConnectionOk() As Boolean
        ...
        Dim connString As String = "Data Source=" & server & ";Initial Catalog=" & cboRegion.SelectedItem.ToString() & ";Persist Security Info=True;User ID=prs92;Password=prs92;Connect Timeout=5"
        Dim retVal As Boolean = False
    ...
    Private Sub LogUserIn()
        ...
        UserName = "thelma"
        Me.Text = Me.Text & "        User: " & UserName & "  Region: " & cboRegion.SelectedItem.ToString()
    End Sub
    ...
    Private Sub btnLogin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLogin.Click
        ...
        If IsConnectionOk() Then
            ...
            ConnString = String.Format(ConnString, cboRegion.SelectedItem.ToString())
            LogUserIn()
        Else
